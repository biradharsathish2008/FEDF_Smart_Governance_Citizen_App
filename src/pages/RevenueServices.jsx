...
function RevenueServices() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    alert('✓ Your revenue service request has been submitted successfully!')
    navigate('/')
  }
    ...
    <div className="app-shell">
      ...
      <main className="page service-detail-page">
        <div className="service-header">
          ...
          <h1>Revenue Department Services</h1>
        </div>
        ...
        <section className="service-content">
          <div className="service-info">
            ...
            <p>
              Access land records, get certificates of ownership, and manage revenue-related applications.
            </p>
          </div>

          <div className="land-records-form">
